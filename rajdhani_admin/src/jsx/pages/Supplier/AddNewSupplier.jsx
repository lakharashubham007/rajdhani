          ...
          <div className="card">
            ...
            <div className="card-body">
              <div>
                ...
                <div className="mb-3 row">
                 <div className="col-sm-3">
                    <label className="col-sm-6 col-form-label">City</label>
                    <input
                      name="city"
                      value={formData.city}
                      onChange={handleChange}
                    ...
                    />
                    {errors.city && (
                      <span className="text-danger fs-12">{errors.city}</span>
                    )}
                  </div>
                  ...
                  <div className="col-sm-3">
                    ...
                    />
                    {errors.state && (
                      <span className="text-danger fs-12">{errors.state}</span>
                    )}
                </div>
                ...
                <div className="col-sm-3">
                  <label className="col-sm-6 col-form-label">GST Numbere</label>
                    <input
                      name="gstNumber"
