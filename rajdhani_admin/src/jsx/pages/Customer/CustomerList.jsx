...
console.log("customerList customerList customerList customerList customerList",customerList)
  const fetchCustomerList = async (sortValue) => {
    ...
    try {
      ...
      setCustomerList(res?.data); // Update state with fetched customer list
              ...
              <div className="table-responsive">
                <div id="holidayList" className="dataTables_wrapper no-footer">
                  ...
                  <table id="example4" className="display dataTable no-footer w-100">
                    ...
                    <tbody>
                      {customerList?.customers?.map((data, ind) => (
