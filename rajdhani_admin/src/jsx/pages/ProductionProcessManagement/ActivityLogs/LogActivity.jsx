...
import { getProductionProcessLogDetailsApi } from "../../../../services/apis/ProductionProcessApi";
...
const LogActivity = () => {
  ...
  // const producitonProcessItems = useSelector((state) => state?.productionProcess?.items);
