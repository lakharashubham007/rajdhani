...
// // import { getProductionProcessItemLogsByItemAndStageApi } from '../../services/apis/ProductionProcessApi';
// import moment from 'moment';
// import { getProductionProcessItemLogsByItemAndStageApi } from '../../../../services/apis/ProductionProcessApi';

// const LogActivityItemsModal = ({ show, onHide, itemId, stage }) => {
...
//           </div>
//         ) : logs.length === 0 ? (
//           <p className="text-center text-muted">No logs found for this item.</p>
//         ) : (
                          ...
                          {activityItemsLogData?.map((data, ind) => (
                            <tr key={ind}>
                              ...
                              <td style={{
                                ...
                                {data?.log_message ? data?.log_message : '-'}
                              </td>
                              ...
                              <td style={{
                                ...
                                {(data?.quantity_accepted === 0) ? '-' : data?.quantity_accepted}
                              </td>
