...
const ProductionProcessPendingList = () => {
    ...
    const fetchPurchaseOrderList = async (sortValue) => {
        ...
        try {
            ...
            const filterpendingOrders = (data) => {
                return data.filter(item => item?.status === "Pending");
            };

            const pendingOrders = filterpendingOrders(rawData);

            setPurchaseOrderList(pendingOrders);
                ...
                <Col lg={12}>
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">🔴 Penging Production Process List</h4>
...
export default ProductionProcessPendingList;
