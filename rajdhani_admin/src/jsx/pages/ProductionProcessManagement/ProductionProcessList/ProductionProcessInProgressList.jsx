...
const ProductionProcessInProgressList = () => {
    ...
    const fetchPurchaseOrderList = async (sortValue) => {
        ...
        try {
            ...
            const rawData = res?.data?.productionSheets;

            const filterinProgressOrders = (data) => {
                return data.filter(item => item?.status === "In Progress");
            };

            const inProgressOrders = filterinProgressOrders(rawData);
    
            setPurchaseOrderList(inProgressOrders);
    ...
    return (
        <>
            ...
            {/* <PageTitle
        activeMenu={"Production Process List"}
        motherMenu={"Home"}
                ...
                <Col lg={12}>
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">🟠 In Progress Production Process List</h4>
...
export default ProductionProcessInProgressList;
