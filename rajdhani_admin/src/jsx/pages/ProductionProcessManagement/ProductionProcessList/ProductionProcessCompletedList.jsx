...
const ProductionProcessCompletedList = () => {
    ...
    const fetchPurchaseOrderList = async (sortValue) => {
        ...
        try {
            ...
            const filterCompletedOrders = (data) => {
                return data.filter(item => item?.status === "Completed");
            };

            const completedOrders = filterCompletedOrders(rawData);

            setPurchaseOrderList(completedOrders);
                ...
                <Col lg={12}>
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">🟢 Completed Production Process List</h4>
...
export default ProductionProcessCompletedList;
