...
import { getPackingDetailsApi } from "../../../services/apis/PackingApi";
...
const PackingRequestList = () => {
  ...
  const fetchPurchaseOrderList = async (sortValue) => {
    ...
    setLoading(true);
    try {
      const res = await getPackingDetailsApi(
        currentPage,
        sort,
        sortValue,
        searchInputValue
      ...
      setPurchaseOrderList(res?.data?.packingDetails);
...
export default PackingRequestList;
