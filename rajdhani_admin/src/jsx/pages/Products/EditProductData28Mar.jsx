...
>
<div>
  {/* Check if the qr_code exists, if not show "N/A" */}
  {data?.qr_code ? (
    <img
      src={data.qr_code}
      alt="QR Code"
      style={{
        ...
        height: '40px',   // You can adjust the height
        objectFit: 'contain', // Ensures the image fits nicely
        borderRadius: '8px',
        // border: '3px solid #ff7a41', 
    ...
    <span style={{ fontSize: '14px', color: '#888' }}>N/A</span> // Show "N/A" when no QR code
  )}
</div>
</td>