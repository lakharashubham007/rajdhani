...
import { getInventoryItemLogsByItemAndSOApi } from "../../../../services/apis/InventoryItemLogsApi";

const theadData = [
  { heading: "S.No.", sortingVale: "sno" },
  { heading: "Date & Time", sortingVale: "time_stamp" },
  { heading: "Activity", sortingVale: "activity" },
  { heading: "Last Assigned Quantity", sortingVale: "quantity_assigned" },
...
const LogActivityItemsModal = ({ show, onHide, itemId, stage, saleOrderID }) => {
  ...
  const fetchItemsActivityLogDetails = async (sortValue) => {
    ...
    // setLoading(true);
    try {
      const res = await getInventoryItemLogsByItemAndSOApi(
        itemId,
        saleOrderID,
        stage,
        currentPage,
