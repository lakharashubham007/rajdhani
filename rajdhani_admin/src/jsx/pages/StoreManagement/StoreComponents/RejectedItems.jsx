...
const theadData = [
  ...
  { heading: "Rejected Quantity", sortingVale: "rejected_quantity" },
  { heading: "Replace Quantity", sortingVale: "replace_quantity" },
  ...
  console.log("inventoryRejectedItemData",inventoryRejectedItemData)
   //   getSubCategoriesApi
    const fetchSaleorders = async (sortValue) => {
      ...
      setLoading(true);
      try {
        const res = await getInventoryRejectionItemsApi(
          params,
          currentPage,
          sort,
          sortValue,
        ...
        setSaleOrderItems(res?.data?.rejectedItems);
        setInventoryRejectedItemData(res?.data?.rejectedItems)
        setRows(res?.data?.rejectedItems)
                ...
                <div className="row">
                  ...
                  <div className="col-sm-4">
                    <h2 className="header-title" style={{ display: 'inline', whiteSpace: 'nowrap' }}>
                      Rajdhani - Rejected and Replace Items 
                    </h2>
                  </div>
                </div>
              ...
              <Col lg={12}>
                <div className="">
                  <div className="card-header pb-0 px-0">
                    <h4 className="card-title">Rejected and Replace Items</h4>
                    <div className="mb-3">
                          ...
                          <tbody >
                            {rows?.map((row, index) => (
                              <tr key={row.id}
                                ...
                                <td style={{
                                  whiteSpace: "nowrap",
                                }}>{row?.product_id?.fitting_Code}</td>
                                {/* product Code */}
                                <td>
                                  <input
                                    type="text"
