...
const StorePackingApprovalList = () => {
  ...
  const fetchPurchaseOrderList = async (sortValue) => {
    ...
    setLoading(true);
    try {
      const res = await getPackingOrderApi(
        currentPage,
        sort,
        sortValue,
        searchInputValue
      );
      console.log(res.data?.data, "-*/-/-*/-/-*/-*/-*/-*/854654654*-/-*/5465-*-*/5445-*")
  ...
  return (
    <>
      ...
      <PageTitle
        activeMenu={"Available Paking Sale Orders"}
        motherMenu={"Store"}
        ...
        <Col lg={12}>
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">Packing Approval Requests</h4>
                        ...
                        <tr key={ind}>
                          ...
                          <td className="d-flex justify-content-start align-items-center gap-2">
                            ...
                            <button
                              ...
                              onClick={() =>
                                navigate(`/packing-items/${data?.so_id?._id}`, {
...
export default StorePackingApprovalList;
