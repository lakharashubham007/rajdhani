...
const theadData = [
  ...
  { heading: "Production Process No.", sortingVale: "production_porocess_no" },
  ...
  { heading: "Rejection Query Date", sortingVale: "rejection_date" },
...
const StoreInventoryRejectionList = () => {
  ...
  const fetchPurchaseOrderList = async (sortValue) => {
    ...
    setLoading(true);
    try {
      const res = await getInventoryRejectionQueryApi(
        currentPage,
        sort,
        sortValue,
        searchInputValue
  ...
  return (
    <>
      ...
      <PageTitle
        activeMenu={"All Rejection Queries"}
        motherMenu={"Store"}
        ...
        <Col lg={12}>
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">Reject / Replacement Requests</h4>
              ...
              <div className="table-responsive">
                <div id="holidayList" className="dataTables_wrapper no-footer">
                  ...
                  <table id="example4" className="display dataTable no-footer w-100">
                    ...
                    <tbody>
                      {purchaseOrderList?.rejectionDetails?.map((data, ind) => (
                        <tr key={ind}>
                          ...
                          <td className="d-flex justify-content-start align-items-center gap-2">
                            ...
                            <button
                              ...
                              onClick={() => navigate(`/rejected-items/${data?._id}`)}
                            >
...
export default StoreInventoryRejectionList;
