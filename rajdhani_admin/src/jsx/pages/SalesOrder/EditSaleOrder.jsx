...
const theadData = [
    ...
    { heading: "Authorize", sortingVale: "verify" },
    { heading: "Action", sortingVale: "edit" },
                            ...
                            <Col lg={12}>
                                <div className="">
                                    <div className="card-header pb-0 px-0">
                                        <h4 className="card-title">Edit SO Product Details</h4>
                                    </div>
                                    <div className="card-body px-0">
                                        <div className="table-responsive">
                                            <div
                                                            ...
                                                            <tr key={row.id}
                                                                ...
                                                                <td tyle={{
                                                                    ...
                                                                    <button className="btn btn-xs sharp btn-primary"
                                                                        // onClick={() => navigate(`/edit-sale-order/${row?._id}`)}
                                                                        onClick={(e) => {
                                                                            const target = e.target;
                ...
                <Modal.Body>
                    {selectedRowData && (
                        ...
                        >
                            ...
                            <div >
                                <h4 className="card-title mt-4">Search Product</h4>
