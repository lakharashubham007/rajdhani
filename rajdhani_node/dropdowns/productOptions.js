...
const ProductOptions = [
 ...
 //added new options
  ...
  const fittingThreadOptions = [
    ...
    { value: "SAE 61", label: "FLG CODE 61- 3000 PSI (3)", code: "FL", dsc_code: "" ,dsc:'61-(3)'},
    { value: "SAE 62", label: "FLG CODE 62- 6000 PSI (6)", code: "FLH", dsc_code: "" ,dsc: '62-(6)'},
  ...
  const fittingTypeOptions = [
    ...
    { value: "Flange", label: "Flange", code: "", dsc_code: "Flange", fitting_thread: "SAE 61" },
    { value: "CAT Flange", label: "CAT Flange", code: "C", dsc_code: "CAT Flange",fitting_thread: "SAE" }
  ];
